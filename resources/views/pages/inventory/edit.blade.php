        ...
        <div class="card-body p-0">
            ...
            <form action="{{ route('inventory.update', $inventory->id) }}" method="POST">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label>Price</label>
                        <input type="number" step="0.01" name="price" value="{{ old('price', $inventory->price) }}"
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" class="form-control @error('description') is-invalid @enderror"
                            placeholder="Masukkan deskripsi (optional)">{{ old('description', $inventory->description) }}</textarea>
